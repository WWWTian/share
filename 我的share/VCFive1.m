...
- (void)viewDidLoad {
    ...
    [_btn1 setTitle:@"上传时间" forState:UIControlStateNormal];
    [_btn1 setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_btn1 setTitle:@"上传时间" forState:UIControlStateSelected];
    ...
    [_btn2 setTitle:@"推荐最多" forState:UIControlStateNormal];
    [_btn2 setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_btn2 setTitle:@"推荐最多" forState:UIControlStateSelected];
    ...
    [_btn3 setTitle:@"分享最多" forState:UIControlStateNormal];
    [_btn3 setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_btn3 setTitle:@"分享最多" forState:UIControlStateSelected];
